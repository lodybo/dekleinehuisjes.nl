...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create kleine-huisjes-b737
  fly apps create kleine-huisjes-b737-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app kleine-huisjes-b737
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app kleine-huisjes-b737-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'kleine-huisjes-b737-staging' does not match app name in config file 'kleine-huisjes-b737'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name kleine-huisjes-b737-db
  fly postgres attach --app kleine-huisjes-b737 kleine-huisjes-b737-db

  fly postgres create --name kleine-huisjes-b737-staging-db
  fly postgres attach --app kleine-huisjes-b737-staging kleine-huisjes-b737-staging-db
  ```
